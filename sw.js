const SEFS_CACHE = 'sefs-pwa-v20260917a';
const SEFS_ASSETS = [
  './',
  './index.html',
  ...
  './manifest.webmanifest?v=20260917a',
  './employee-portal.webmanifest',
  './employee-portal.webmanifest?v=20260917a',
  './mobile-measure.webmanifest',
  './mobile-measure.webmanifest?v=20260917a',
  './mobile-job.webmanifest',
  './mobile-job.webmanifest?v=20260917a',
  './inventory-management.webmanifest',
  './inventory-management.webmanifest?v=20260917a',
  './pwa-init.js',
  './pwa-init.js?v=20260917a',
