const SEFS_CACHE = 'sefs-pwa-v20260814a';
const SEFS_ASSETS = [
  './',
  './index.html',
  ...
  './manifest.webmanifest?v=20260814a',
  './employee-portal.webmanifest',
  './employee-portal.webmanifest?v=20260814a',
  './mobile-measure.webmanifest',
  './mobile-measure.webmanifest?v=20260814a',
  './mobile-job.webmanifest',
  './mobile-job.webmanifest?v=20260814a',
  './inventory-management.webmanifest',
  './inventory-management.webmanifest?v=20260814a',
  './pwa-init.js',
  './pwa-init.js?v=20260814a',
