const SEFS_CACHE = 'sefs-pwa-v20260817c';
const SEFS_ASSETS = [
  './',
  './index.html',
  ...
  './manifest.webmanifest?v=20260817c',
  './employee-portal.webmanifest',
  './employee-portal.webmanifest?v=20260817c',
  './mobile-measure.webmanifest',
  './mobile-measure.webmanifest?v=20260817c',
  './mobile-job.webmanifest',
  './mobile-job.webmanifest?v=20260817c',
  './inventory-management.webmanifest',
  './inventory-management.webmanifest?v=20260817c',
  './pwa-init.js',
  './pwa-init.js?v=20260817c',
