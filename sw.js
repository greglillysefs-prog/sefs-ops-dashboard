const SEFS_CACHE = 'sefs-pwa-v20260922a';
const SEFS_ASSETS = [
  './',
  './index.html',
  ...
  './manifest.webmanifest?v=20260922a',
  './employee-portal.webmanifest',
  './employee-portal.webmanifest?v=20260922a',
  './mobile-measure.webmanifest',
  './mobile-measure.webmanifest?v=20260922a',
  './mobile-job.webmanifest',
  './mobile-job.webmanifest?v=20260922a',
  './inventory-management.webmanifest',
  './inventory-management.webmanifest?v=20260922a',
  './pwa-init.js',
  './pwa-init.js?v=20260922a',
