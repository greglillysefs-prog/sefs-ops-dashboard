const SEFS_CACHE = 'sefs-pwa-v20260922b';
const SEFS_ASSETS = [
  './',
  './index.html',
  ...
  './manifest.webmanifest?v=20260922b',
  './employee-portal.webmanifest',
  './employee-portal.webmanifest?v=20260922b',
  './mobile-measure.webmanifest',
  './mobile-measure.webmanifest?v=20260922b',
  './mobile-job.webmanifest',
  './mobile-job.webmanifest?v=20260922b',
  './inventory-management.webmanifest',
  './inventory-management.webmanifest?v=20260922b',
  './pwa-init.js',
  './pwa-init.js?v=20260922b',
