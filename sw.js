const SEFS_CACHE = 'sefs-pwa-v20260817b';
const SEFS_ASSETS = [
  './',
  './index.html',
  ...
  './employee-portal.webmanifest?v=20260817b',
  './mobile-measure.webmanifest',
  './mobile-measure.webmanifest?v=20260817b',
  './mobile-job.webmanifest',
  './mobile-job.webmanifest?v=20260817b',
  './inventory-management.webmanifest',
  './inventory-management.webmanifest?v=20260817b',
  './pwa-init.js',
  './pwa-init.js?v=20260817b',
