const SEFS_CACHE = 'sefs-pwa-v20260817a';
const SEFS_ASSETS = [
  './',
  './index.html',
  ...
  './manifest.webmanifest?v=20260817a',
  './employee-portal.webmanifest',
  './employee-portal.webmanifest?v=20260817a',
  './mobile-measure.webmanifest',
  './mobile-measure.webmanifest?v=20260817a',
  './mobile-job.webmanifest',
  './mobile-job.webmanifest?v=20260817a',
  './inventory-management.webmanifest',
  './inventory-management.webmanifest?v=20260817a',
  './pwa-init.js',
  './pwa-init.js?v=20260817a',
