const SEFS_CACHE = 'sefs-pwa-v20260917b';
const SEFS_ASSETS = [
  './',
  './index.html',
  ...
  './employee-portal.webmanifest?v=20260917b',
  './mobile-measure.webmanifest',
  './mobile-measure.webmanifest?v=20260917b',
  './mobile-job.webmanifest',
  './mobile-job.webmanifest?v=20260917b',
  './inventory-management.webmanifest',
  './inventory-management.webmanifest?v=20260917b',
  './pwa-init.js',
  './pwa-init.js?v=20260917b',
